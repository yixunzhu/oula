...
def test_001_oracle_user():
    ...
    high_risk_resources.add_high_risk_source_permission_no_database(_oracleUser_permission, _connection, _oracleUser)
...
def test_003_only_apply_one_permission():
    ...
    _sql_list = list(oracle_connection_sql.values())
    high_risk_resources.delete_all_high_risk_source_permission(_connection)
    high_risk_resources.add_high_risk_source_permission_no_database(["Insert"], _connection, _oracleUser)
    for i in _sql_list:
