...
def test_001_table():
    ...
    :return:
    """
    _sql_list = list(oracle_table_sql.values())
    ...
    high_risk_resources.add_high_risk_source_permission_no_database(_table_permission, _connection, _oracleUser, "表", _table)
...
def test_003_only_apply_one_permission():
    ...
    high_risk_resources.delete_all_high_risk_source_permission(_connection)
    high_risk_resources.add_high_risk_source_permission_no_database(["Insert"], _connection, _oracleUser, "表", _table)
    for i in _sql_list:
