...
def test_001_database():
    ...
    high_risk_resources.add_high_risk_source_permission_yes_database(_connection_permission, _connection, "SALESPDB")
...
def test_003_only_apply_one_permission():
    ...
    high_risk_resources.delete_all_high_risk_source_permission(_connection)
    high_risk_resources.add_high_risk_source_permission_yes_database(["Insert"], _connection, "SALESPDB")
    for i in _sql_list:
