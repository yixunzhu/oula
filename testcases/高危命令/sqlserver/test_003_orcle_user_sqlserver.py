...
def test_001_oracle_user():
    ...
    """
    _sql_list = list(sqlserver_oracleUser_sql.values())
    ...
    high_risk_resources.add_high_risk_source_permission_yes_database(_connection_permission, _connection, _database, _sqlserverUser)
...
def test_003_only_apply_one_permission():
    ...
    :return:
    """
    _sql_list = list(sqlserver_connection_sql.values())
    high_risk_resources.delete_all_high_risk_source_permission(_connection)
    high_risk_resources.add_high_risk_source_permission_yes_database(["Insert"], _connection, _database, _sqlserverUser)
    for i in _sql_list:
