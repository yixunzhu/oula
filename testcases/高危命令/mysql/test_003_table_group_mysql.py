...
def test_001_table_group():
    ...
    high_risk_resources.add_high_risk_source_permission_no_database(_tableGroup_permission, _connection, _mysqlUser, "表")
...
def test_003_only_apply_one_permission():
    ...
    _sql_list = list(mysql_connection_sql.values())
    high_risk_resources.delete_all_high_risk_source_permission(_connection)
    high_risk_resources.add_high_risk_source_permission_no_database(["Insert"], _connection, _mysqlUser, "表")
    for i in _sql_list:
